...
const dict = {
  ...
  'feeds.comments': { ja: 'コメントした記事', en: 'Commented' },
  ...
  'hint.comments': { ja: '自分でメモや感想を書いた記事。あとから振り返りたい記事の置き場として使えます。', en: 'Articles with your own notes or reactions. Use this as a place to revisit what mattered.' },
  ...
  'article.characterCount': { ja: '${count}文字', en: '${count} chars' },
  ...
  'article.refetch': { ja: '再取得', en: 'Refetch' },
  'article.refetching': { ja: '再取得中...', en: 'Refetching...' },
  ...
  'article.comment': { ja: 'コメント', en: 'Comment' },
  'article.commentPlaceholder': { ja: 'この記事についてメモや感想を書く', en: 'Write a note or reaction about this article' },
  ...
  'articles.bulkRefetch': { ja: '再取得', en: 'Refetch' },
  'articles.bulkRefetching': { ja: '再取得中...', en: 'Refetching...' },
  ...
  'siteAccess.title': { ja: '認証付きサイトアクセス', en: 'Authenticated Site Access' },
  'siteAccess.desc': { ja: 'サイトごとに Cookie と対象ドメインを登録し、一致したときだけ認証付きで本文取得します', en: 'Register cookies and target domains per site, and fetch with authentication only on matching domains' },
  'siteAccess.enabled': { ja: '認証付き取得を有効化', en: 'Enable authenticated fetch' },
  'siteAccess.enabledDesc': { ja: '有効化すると、対象ドメインへの取得時に保存済み Cookie を送信します', en: 'When enabled, stored cookies are sent for requests to target domains' },
  'siteAccess.addProfile': { ja: 'プロファイル追加', en: 'Add Profile' },
  'siteAccess.removeProfile': { ja: '削除', en: 'Remove' },
  'siteAccess.profileName': { ja: 'プロファイル名', en: 'Profile name' },
  'siteAccess.profileNamePlaceholder': { ja: 'note / nikkei など', en: 'note / nikkei / etc.' },
  'siteAccess.domains': { ja: '対象ドメイン', en: 'Target domains' },
  'siteAccess.domainsPlaceholder': { ja: 'note.com\ncontents.note.com', en: 'note.com\ncontents.note.com' },
  'siteAccess.domainsDesc': { ja: '改行・カンマ・空白区切りで複数指定できます。サブドメインも一致対象です', en: 'Separate multiple domains with newlines, commas, or spaces. Subdomains also match' },
  'siteAccess.cookie': { ja: 'Cookie', en: 'Cookie' },
  'siteAccess.cookiePlaceholder': { ja: 'sessionid=...; other=value', en: 'sessionid=...; other=value' },
  'siteAccess.cookieConfigured': { ja: 'Cookie は保存済みです。更新する場合のみ再入力してください', en: 'A cookie is already stored. Re-enter only when updating it' },
  'siteAccess.cookieNotConfigured': { ja: 'Cookie は未設定です', en: 'No cookie configured yet' },
  'siteAccess.lastSyncAt': { ja: '最終セッション同期', en: 'Last session sync' },
  'siteAccess.testUrl': { ja: 'テストURL', en: 'Test URL' },
  'siteAccess.testUrlPlaceholder': { ja: 'https://note.com/.../n/...', en: 'https://note.com/.../n/...' },
  'siteAccess.testUrlDesc': { ja: '任意。購読済みの有料記事URLを入れると、期限切れやログイン誘導を判定しやすくなります。未入力時は先頭ドメインのトップページを使います', en: 'Optional. Use a subscriber-only article URL to better detect expired sessions or login walls. If blank, the first target domain root is used' },
  'siteAccess.test': { ja: '接続テスト', en: 'Test Connection' },
  'siteAccess.testing': { ja: 'テスト中...', en: 'Testing...' },
  'siteAccess.save': { ja: '保存', en: 'Save' },
  'siteAccess.clear': { ja: '削除', en: 'Clear' },
  'siteAccess.saved': { ja: 'サイトアクセス設定を保存しました', en: 'Site access settings saved' },
  'siteAccess.cleared': { ja: 'サイトアクセス設定を削除しました', en: 'Site access settings cleared' },
